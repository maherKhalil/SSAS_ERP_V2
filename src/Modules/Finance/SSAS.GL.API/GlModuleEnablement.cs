...
// ==================================================================================================
// FINANCE.GL'S MODULE KEY, FOR ENABLEMENT (FP-014, OD-SUB-0005).
// ==================================================================================================
//
// ---- THE UNIT IS THE MODULE, NOT THE ROUTE GROUP.
//
// This module mounts one route group covering accounts, the fiscal calendar, drafts, posted journals and reporting.
...
public sealed class GlModuleEnablement : IModuleEnablementDescriptor
{
  public const string Key = "Finance.GL";
