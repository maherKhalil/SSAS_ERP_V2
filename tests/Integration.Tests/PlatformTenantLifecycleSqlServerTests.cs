...
public sealed class PlatformTenantLifecycleSqlServerTests
{
  ...
  public async Task Complete_migration_chain_enforces_tenant_sql_server_invariants()
  {
    ...
    Assert.Equal(["AuthenticationSessions", "Companies_MigratedToTenant", "TenantDatabaseAssignments", "TenantLocalizationOverrides", "TenantLocalizationSettings"], await ReadStringsAsync(
      context,
