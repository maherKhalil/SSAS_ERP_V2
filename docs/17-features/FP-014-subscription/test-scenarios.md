...
| `TS-SUB-0029` | Login is refused for an expired tenant and for a suspended tenant, and the two produce **different** modelled outcomes. Asserted on the outcome, not the public response, which stays generic under `FP-002` | `AC-SUB-0029` |
