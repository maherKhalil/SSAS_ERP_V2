...
{
  public async Task<Result> HandleAsync(ActivateCompanyCommand command, CancellationToken cancellationToken = default)
  {
    ...
    var transition = company.Activate(command.ReasonCode, context.Value.Actor, Guid.NewGuid(), clock.UtcNow);
