...
public sealed class DeactivateTenantUserCommandHandler(
...
{
  public async Task<Result> HandleAsync(DeactivateTenantUserCommand command, CancellationToken cancellationToken = default)
  {
    ...
    var domainResult = tenantUser.Deactivate(Guid.NewGuid(), clock.UtcNow);
