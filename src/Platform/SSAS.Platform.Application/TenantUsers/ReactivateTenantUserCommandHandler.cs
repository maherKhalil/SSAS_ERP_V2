...
public sealed class ReactivateTenantUserCommandHandler(
...
{
  public async Task<Result> HandleAsync(ReactivateTenantUserCommand command, CancellationToken cancellationToken = default)
  {
    ...
    var domainResult = tenantUser.Reactivate(Guid.NewGuid(), clock.UtcNow);
