...
{
  public async Task<Result> HandleAsync(DeactivateCompanyCommand command, CancellationToken cancellationToken = default)
  {
    ...
    var transition = company.Deactivate(command.ReasonCode, context.Value.Actor, Guid.NewGuid(), clock.UtcNow);
