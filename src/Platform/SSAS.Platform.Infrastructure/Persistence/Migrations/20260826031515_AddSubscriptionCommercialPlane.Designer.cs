...
namespace SSAS.Platform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260826031515_AddSubscriptionCommercialPlane")]
    partial class AddSubscriptionCommercialPlane
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSAS.Platform.Domain.Subscriptions.ModuleDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ModuleDefinitions", "platform", t =>
                        {
                            t.HasCheckConstraint("CK_ModuleDefinitions_ModuleKey_NotBlank", "LEN(LTRIM(RTRIM([ModuleKey]))) > 0");
                        });
                });
            ...
            modelBuilder.Entity("SSAS.Platform.Domain.Subscriptions.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<string>("NormalizedPlanCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .UseCollation("Latin1_General_100_BIN2");
                    ...
                    b.HasIndex("NormalizedPlanCode")
                        .IsUnique()
                        .HasDatabaseName("UX_SubscriptionPlans_NormalizedPlanCode");

                    b.ToTable("SubscriptionPlans", "platform", t =>
                        {
                            t.HasCheckConstraint("CK_SubscriptionPlans_PlanCode_NotBlank", "LEN(LTRIM(RTRIM([PlanCode]))) > 0");

                            t.HasCheckConstraint("CK_SubscriptionPlans_PlanName_NotBlank", "LEN(LTRIM(RTRIM([PlanName]))) > 0");

                            t.HasCheckConstraint("CK_SubscriptionPlans_Status", "[Status] IN (N'Draft', N'Active', N'Retired')");
                        });
                });

            modelBuilder.Entity("SSAS.Platform.Domain.Subscriptions.TenantEntitlementGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("TenantEntitlementGrants", "platform", t =>
                        {
                            t.HasCheckConstraint("CK_TenantEntitlementGrants_Expiry", "[ExpiresUtc] IS NULL OR [ExpiresUtc] > [EffectiveFromUtc]");

                            t.HasCheckConstraint("CK_TenantEntitlementGrants_GrantKind", "[GrantKind] IN (N'ModuleGrant', N'LimitRaise')");

                            t.HasCheckConstraint("CK_TenantEntitlementGrants_LimitValue", "[LimitValue] IS NULL OR [LimitValue] >= 0");

                            t.HasCheckConstraint("CK_TenantEntitlementGrants_Shape", "([GrantKind] = N'ModuleGrant' AND [ModuleKey] IS NOT NULL AND [LimitKey] IS NULL AND [LimitValue] IS NULL) OR ([GrantKind] = N'LimitRaise' AND [ModuleKey] IS NULL AND [LimitKey] IS NOT NULL AND [LimitValue] IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("SSAS.Platform.Domain.Subscriptions.TenantSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("ChangeReasonText")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
                    ...
                    b.ToTable("TenantSubscriptions", "platform", t =>
                        {
                            t.HasCheckConstraint("CK_TenantSubscriptions_Term", "([TermKind] = N'Perpetual' AND [TermEndUtc] IS NULL) OR ([TermKind] = N'Fixed' AND [TermEndUtc] IS NOT NULL AND [TermEndUtc] > [TermStartUtc])");

                            t.HasCheckConstraint("CK_TenantSubscriptions_TermKind", "[TermKind] IN (N'Fixed', N'Perpetual')");
                        });
                });

            modelBuilder.Entity("SSAS.Platform.Domain.TenantStorage.TenantCutoverOperation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTimeOffset?>("FreezeReleasedUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("FreezeRequestedUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("FrozenUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("PostCutoverWriteObservedUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("RoutingFlippedUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<long>("SourceTenantDatabaseId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("TargetTenantDatabaseId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SourceTenantDatabaseId");

                    b.HasIndex("TargetTenantDatabaseId");
                    ...
                    b.ToTable("TenantCutoverOperations", "platform", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_TenantCutoverOperations_FlipRecordsVersion", "[RoutingFlippedUtc] IS NULL OR [RoutingVersion] IS NOT NULL");

                            t.HasCheckConstraint("CK_TenantCutoverOperations_FlippedHasFlipTimestamp", "[Status] NOT IN (N'RoutingFlipped', N'Completed') OR [RoutingFlippedUtc] IS NOT NULL");

                            t.HasCheckConstraint("CK_TenantCutoverOperations_FrozenHasTimestamp", "[Status] <> N'Frozen' OR [FrozenUtc] IS NOT NULL");

                            t.HasCheckConstraint("CK_TenantCutoverOperations_PostCutoverWriteFollowsFlip", "[PostCutoverWriteObservedUtc] IS NULL OR ([RoutingFlippedUtc] IS NOT NULL AND [PostCutoverWriteObservedUtc] >= [RoutingFlippedUtc])");

                            t.HasCheckConstraint("CK_TenantCutoverOperations_Status", "[Status] IN (N'Preparing', N'Frozen', N'RoutingFlipped', N'Completed', N'Abandoned')");
                        });
                });
            ...
            modelBuilder.Entity("SSAS.Platform.Domain.Subscriptions.SubscriptionPlan", b =>
                {
                    b.OwnsMany("SSAS.Platform.Domain.Subscriptions.PlanLimit", "Limits", b1 =>
                        {
                            ...
                            b1.HasKey("SubscriptionPlanId", "LimitKey");

                            b1.ToTable("SubscriptionPlanLimits", "platform", t =>
                                {
                                    t.HasCheckConstraint("CK_SubscriptionPlanLimits_LimitValue", "[LimitValue] >= 0");
                                });
                    ...
                    b.OwnsMany("SSAS.Platform.Domain.Subscriptions.PlanModuleGrant", "ModuleGrants", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionPlanId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("SubscriptionPlanId");
                            ...
                            b1.HasKey("SubscriptionPlanId", "ModuleKey");

                            b1.ToTable("SubscriptionPlanModules", "platform");

                            b1.WithOwner()
                                .HasForeignKey("SubscriptionPlanId");
                        });

                    b.OwnsMany("SSAS.Platform.Domain.Subscriptions.PlanPrice", "Prices", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionPlanId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("SubscriptionPlanId");
                            ...
                            b1.HasKey("SubscriptionPlanId", "CurrencyCode", "BillingPeriod");

                            b1.ToTable("SubscriptionPlanPrices", "platform", t =>
                                {
                                    t.HasCheckConstraint("CK_SubscriptionPlanPrices_Amount", "[Amount] >= 0");

                                    t.HasCheckConstraint("CK_SubscriptionPlanPrices_BillingPeriod", "[BillingPeriod] IN (N'Monthly', N'Annual')");
                                });
            ...
            modelBuilder.Entity("SSAS.Platform.Domain.Subscriptions.TenantSubscription", b =>
                {
                    b.HasOne("SSAS.Platform.Domain.Subscriptions.SubscriptionPlan", null)
                        .WithMany()
                        .HasForeignKey("SubscriptionPlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.OwnsOne("SSAS.Platform.Domain.ValueObjects.SubscriptionTerm", "Term", b1 =>
                        {
                            b1.Property<Guid>("TenantSubscriptionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<string>("Kind")
                                ...
                                .HasMaxLength(32)
                                .HasColumnType("nvarchar(32)")
                                .HasColumnName("TermKind");

                            b1.Property<DateTimeOffset>("StartUtc")
                                .HasColumnType("datetimeoffset")
                                .HasColumnName("TermStartUtc");

                            b1.HasKey("TenantSubscriptionId");

                            b1.ToTable("TenantSubscriptions", "platform");
            ...
            modelBuilder.Entity("SSAS.Platform.Domain.TenantStorage.TenantCutoverOperation", b =>
                {
                    b.HasOne("SSAS.Platform.Domain.TenantStorage.TenantDatabase", null)
                        .WithMany()
                        .HasForeignKey("SourceTenantDatabaseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SSAS.Platform.Domain.TenantStorage.TenantDatabase", null)
                        .WithMany()
                        .HasForeignKey("TargetTenantDatabaseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
