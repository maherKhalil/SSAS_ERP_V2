...
public sealed class ReenablePlatformSupportPrincipalCommandHandler(
  ...
  IDateTimeProvider clock)
{
  public async Task<Result> HandleAsync(
    ReenablePlatformSupportPrincipalCommand command,
    CancellationToken cancellationToken = default)
  {
    ...
    var domainResult = principal.Reenable(actor.Value, clock.UtcNow);
