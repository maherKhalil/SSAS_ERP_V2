...
// ==================================================================================================
// ATTENDANCE'S MODULE KEY, FOR ENABLEMENT (FP-014, OD-SUB-0005).
// ==================================================================================================
//
// ---- THE UNIT IS THE MODULE, NOT THE ROUTE GROUP.
//
// This module mounts one route group covering the working calendar, periods, records and adjustments, leave types, leave requests and balances.
...
public sealed class AttendanceModuleEnablement : IModuleEnablementDescriptor
{
  public const string Key = "Attendance";
